...
- **Progress**: Strength Index, and a Records list of every lift's best set grouped by muscle group (collapsed by default). Tap a lift for its per-exercise trend lines (estimated 1RM and session volume).
