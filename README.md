...
- **Rotation**: every muscle group's "days since last trained" is ranked on Home, and the Rotation tab shows it on a body map: a front and back figure with each muscle coloured green, orange or red by how due it is. Tap a muscle to see which of your groups train it.
...
- **Muscle groups**: picked from a catalog of 35, from broad ("Legs", "Back", "Shoulders") to specific (the three deltoid heads, rotator cuff, hip flexors, gastroc vs soleus). New installs start with Chest, Back, Shoulders, Biceps, Triceps, Legs, Quads, Abs, and Cardio. Where a broad and a specific group both cover a muscle, the map shows the specific one.
